INSERT INTO t_tariff(c_id, c_duration_unit, c_duration_value, с_is_active, c_price_per_unit, c_sub_duration_days,
                     c_title, c_type, c_unlock_fee, c_valid_from, c_valid_untill)
